...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field_location_index', models.IntegerField(unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensor_field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='air_sensor_of_field', to='Api.field')),
            ],
        ),
        migrations.CreateModel(
            name='Production',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_from_fround_sensor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ground_sensor', to='Api.iodevice')),
            ],
        ),
        migrations.AddField(
            model_name='crop',
