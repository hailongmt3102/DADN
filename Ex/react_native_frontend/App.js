...
import FieldPageScreen from './src/screens/fieldPage'
		...
		>
			...
			>
				...
				<Stack.Screen
					...
					options={{ title: "🌳 Danh sách khu vực " }}
				/>

				<Stack.Screen
					name="fieldPage"
					component={FieldPageScreen}
					options={({route}) => ({title: "🌳 Khu vực " + route.params.field_id})}
				/>
			</Stack.Navigator>
		</NavigationContainer>
	);
